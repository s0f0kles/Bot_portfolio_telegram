...
/start - запуск бота
/info - информацыя
/new_project - используй для добавления нового проекта, ссылку на проект, статуса проекта
/skills - используй для добавления навыка
/projects - список проектов
/delete - удаляет проект по имени
/update_projects - изменяет пронкт
