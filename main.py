...
💼 **Что я умею?**
Я помогу тебе сохранить информацию о твоих проектах и всегда держать их под рукой! 🙌 
""")
    info(message)
    
@bot.message_handler(commands=['info'])#shows information about bot's abilities 
def info(message):
    bot.send_message(message.chat.id,
"""
🔧 **Команды, которые могут тебе помочь:**
- **/start** — 🚀 Запуск бота и приветствие.
- **/info** — ℹ️ Узнать больше обо мне.
- **/new_project** — ✏️ Добавь новый проект, ссылку на него и статус.
- **/skills** — 💡 Добавь свои навыки, чтобы помнить о них.
- **/projects** — 📋 Просмотри список всех проектов.
- **/delete** — 🗑 Удали проект по имени.
- **/update_projects** — 🔄 Обнови информацию о проекте.

....
🔍 **Дополнительно:**
Просто введи **имя проекта**, и я подскажу тебе всю информацию о нём! 🗂!""")
    

@bot.message_handler(commands=['new_project'])#it adds new project to basedata
def addtask_command(message):
    bot.send_message(message.chat.id, "Введите название проекта:")
    bot.register_next_step_handler(message, name_project)

def name_project(message):#we add the description for our project
    name = message.text
...
def description_name(message, data):#we add link for our project
...
def link_project(message, data):#we add status for our project
...
@bot.message_handler(commands=['skills'])#we choose the skills for our project
...
@bot.message_handler(commands=['projects'])#it shows all project we have
...
@bot.message_handler(commands=['delete'])#it deletes the choosen project
...
@bot.message_handler(commands=['update_projects'])#we can change choosen project
